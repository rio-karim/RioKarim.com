...
(function() {
  'use strict'
let i; var j; var abs = Math.abs; var sin = Math.sin; var cos = Math.cos; var max = Math.max;
  var min = Math.min; var ceil = Math.ceil; var sqrt = Math.sqrt; var pow = Math.pow;
  var hexlookup3 = {}; var hexlookup2 = {}; var hexlookup1 = {
  0:"0,",   1:"17,",  2:"34,",  3:"51,",  4:"68,",  5:"85,",
  6:"102,", 7:"119,", 8:"136,", 9:"153,", a:"170,", A:"170,",
  b:"187,", B:"187,", c:"204,", C:"204,", d:"221,", D:"221,",
  e:"238,", E:"238,", f:"255,", F:"255,"
  }; var Oproto; var Tproto; var TCproto; var Mproto; var Vproto; var TSproto; var TCVproto;
  var doc = document; var ocanvas; var handlers = {};
  for (i = 0; i < 256; ++i) {
    j = i.toString(16)
    if (i < 16) j = '0' + j
  ...
  let sina = sin(angle); var cosa = cos(angle); var mcos = 1 - cosa;
    return new Matrix([
      cosa + pow(u.x, 2) * mcos,
  ...
  let a = []; var i; var j; var mmatrix = (m.xform ? 1 : 0);
    for (i = 1; i <= 3; ++i)
      for (j = 1; j <= 3; ++j) {
        if (mmatrix)
          a.push(
  ...
  let a = {}; var x = p.x; var y = p.y; var z = p.z;
  ...
  let i; var y; var r; var phi; var pts = []; var off = 2/n; var inc;
  ...
  let phi; var pts = []; var inc = Math.PI * 2 / n; var i; var k; var l;
    for (i = 0; i < n; ++i) {
      phi = i * inc
      k = cos(phi)
      l = sin(phi)
  ...
  let i = new Image;
    i.onload = function() {
    let dx = i.width / 2; var dy = i.height / 2;
  ...
  let l = 1024; var h = 1; var gl = tc.weightGradient; var cv; var c; var i; var d;
    if (tc.gCanvas) {
  ...
  function TextSet(
    ...
    var xo =
        ...
        (shadowOffsets.length && shadowOffsets[0] < 0
          ? abs(shadowOffsets[0])
          : 0);
    var yo = pady + (shadowBlur || 0) +
    (shadowOffsets.length && shadowOffsets[1] < 0 ? abs(shadowOffsets[1]) : 0); var i; var xc;
    ctxt.font = font
  ...
  function AddBackgroundToImage(
    ...
    var ch = h + ((2 * padding) + othickness) * scale;
    var cv = NewCanvas(cw, ch); var c; var x1; var y1; var x2; var y2; var ocanvas; var cc; var rr;
    if (!cv) return null
    othickness *= scale
    radius *= scale
    x1 = y1 = othickness / 2
  ...
  let sw = abs(so[0]); var sh = abs(so[1]);
    var cw = w + (sw > sb ? sw + sb : sb * 2) * scale;
    var ch = h + (sh > sb ? sh + sb : sb * 2) * scale;
    var xo = scale * ((sb || 0) + (so[0] < 0 ? sw : 0));
    var yo = scale * ((sb || 0) + (so[1] < 0 ? sh : 0)); var cv; var c;
    cv = NewCanvas(cw, ch)
    if (!cv) return null
    c = cv.getContext('2d')
    sc && (c.shadowColor = sc)
  ...
  let s = tc.imageScale; var mscale; var ic; var bc; var oc; var iw; var ih;
  ...
  let xy; var p; var xmul = parseInt(GetProperty(c, 'width')) / c.width;
    var ymul = parseInt(GetProperty(c, 'height')) / c.height;
  ...
  let i; var t = TagCanvas; var tc; var p; var tg = EventToCanvasId(e);
    for (i in t.tc) {
      tc = t.tc[i]
      if (tc.tttimer) {
  ...
  function MouseUp(e) {
  let t = TagCanvas; var cb = doc.addEventListener ? 0 : 1;
    var tg = EventToCanvasId(e); var tc;
    if (tg && e.button == cb && t.tc[tg]) {
      tc = t.tc[tg]
      MouseMove(e)
  ...
  let t = TagCanvas; var tg = EventToCanvasId(e);
    if (tg && t.tc[tg]) {
      e.cancelBubble = true
      e.returnValue = false
  ...
  let r = e ? 1 : 0; var cn; var cl; var i;
    e = e || this.e
    cn = e.childNodes
    cl = cn.length
  ...
  let i; var l = this.text.length; var w = 0; var wl;
    for (i = 0; i < l; ++i) {
  ...
  let extents = FindTextBoundingBox(this.text, this.textFont, this.textHeight);
    var s; var th; var f; var soff; var cw; var twidth; var theight; var img; var tcv;
  ...
  let tc = this.tc; var modes = tc.weightMode.split(/[, ]/); var m; var s; var wl = w.length;
  ...
  let x = this.x; var y = this.y; var s = this.sc;
    var i = im || this.fimage; var w = this.w; var h = this.h; var a = this.alpha;
  ...
  let o = this.outline; var w = this.w; var h = this.h;
    var x = this.x - w/2; var y = this.y - h/2;
  ...
  let a = this.a; var t = a.target; var h = a.href; var evt;
    if (t != '' && t != '_self') {
      if (self.frames[t]) {
  ...
  let el = this.SourceElements(); var etl; var tl = []; var i; var j; var k;
  ...
  let tl = []; var i; var p; var tc = text.split(''); var a; var t; var x; var z;
  ...
  let im; var i; var t; var txt; var ts; var font; var bc; var boc; var p = [0, 0, 0];
  ...
  TCproto.UpdateTag = function(t, a) {
    ...
    var font = this.textFont || FixFont(GetProperty(a, 'font-family'));
    var bc = this.bgColour == 'tag' ? GetProperty(a, 'background-color') :
      this.bgColour; var boc = this.bgOutline == 'tag' ? GetProperty(a, 'color') :
      this.bgOutline;
    t.a = a
    t.title = a.title
    if (
  ...
  let ll = tl.length; var w; var i; var s; var weights = []; var valid;
    var wfrom = this.weightFrom ? this.weightFrom.split(/[, ]/) : [null];
    var wl = wfrom.length;
    for (i = 0; i < ll; ++i) {
      weights[i] = []
      for (s = 0; s < wl; ++s) {
  ...
  let tl = this.GetTags(); var taglist = []; var shape; var t;
    var shapeArgs; var rx; var ry; var rz; var vl; var i; var tagmap = []; var pfuncs = {
  ...
  let tl = this.GetTags(); var newlist = [];
    var taglist = this.taglist; var found;
    var added = []; var removed = []; var vl; var ol; var nl; var i; var j;
  ...
  let tc = this; var rs = 100 * t * tc.maxSpeed / tc.max_radius / tc.zoom;
    if (tc.dx || tc.dy) {
  ...
  let s = tc.minSpeed; var ay = abs(tc.yaw); var ap = abs(tc.pitch);
  ...
  TCproto.Drag = function(e, p) {
    if (this.dragControl && this.down) {
      ...
      var dx = p.x - this.down.x; var dy = p.y - this.down.y;
  ...
  let z; var d; var p = this.pinched;
    if (!p) return
    d = PinchDistance(e)
    z = (p[1] * d) / p[0]
    this.zoom = min(this.zoomMax, max(this.zoomMin, z))
  ...
  let t = tag.Calc(this.transform, 1); var v1 = new Vector(t.x, t.y, t.z);
    var v2 = MakeVector(lg, lt); var angle = v1.angle(v2); var u = v1.cross(v2).unit();
    if (angle == 0) {
